...
class distributionActivitiesWizard(models.TransientModel):
	_name="distribution.activities"
	...
	def get_report(self):
		...
		return self.env.ref('kamil_hr_career.distribution_activities_report').report_action(self, data=data)