...
class WizExpensesJournal(models.TransientModel):
	_name ='wiz.expenses.journal'
	...
	group_id = fields.Many2one('account.account',string='Groups', domain=lambda self:self.get_expense_accounts_domain() )
	...
	def print_report(self):
		...
		return self.env.ref('kamil_accounting_reports.expenses_journal_report').report_action(self, data=data)
