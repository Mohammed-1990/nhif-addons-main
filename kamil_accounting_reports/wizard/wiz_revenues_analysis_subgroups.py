...
class WizRevenuesAnalysisSubgroups(models.TransientModel):
	_name ='wiz.revenues.analysis.subgroups'
	...
	group_id = fields.Many2one('account.account', domain=lambda self:self.get_revenue_accounts_domain() ,string='Choose Account/Group')
	...
	def print_report(self):
		...
		return self.env.ref('kamil_accounting_reports.rev_analysis_sub_report').report_action(self, data=data)
