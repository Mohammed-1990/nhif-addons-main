odoo.define('scrap_request.widget', function(require) {
"use strict";
 ...
 * create_move on the object scrap.request.line.
 * Note that this widget can only work on the scrap.request.line
...
var ScrapRequestWidget = AbstractField.extend({
...
registry.add("deprec_lines_toggler", ScrapRequestWidget);
