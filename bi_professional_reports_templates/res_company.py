...
class account_invoice(models.Model):
    ...
    # def get_default_img():
    # with open(modules.get_module_resource('rs.company', 'static/img', 'my_image.png'),
    #           'rb') as f:
...
#
#     group_sale_order_template = fields.Boolean("sale template")
#     sale_order_template_id = fields.Many2one('sale.order.template',string = 'sale template')
