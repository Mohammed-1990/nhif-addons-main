{
	...
	'sequence' : 0,
	'data':[
		'security/ratification_groups.xml',
		...
		'views/money_shortage_notification_view.xml',

		'views/manual_journal.xml',
		...
		'wizard/ratification_complex.xml',

		],
	'depends' : ['base','kamil_accounting_base','account','html_text','kamil_accounting_revenues_collection','stock','web_notify', 'account_cancel','kamil_accounting_money_supply'],
}
